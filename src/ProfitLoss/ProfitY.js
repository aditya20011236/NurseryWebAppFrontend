...
//       const expensesResponse = await axios.get(host+'/api/expenses/expenses/getDataBetweenDates/date', {
...
//       const salesResponse = await axios.get(host+'/api/invoices/getDataBetweenDates/date', {

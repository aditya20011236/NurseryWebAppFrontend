...
//       setEndDate(`${selectedYear}-${selectedMonthObj.numerical}-${daysInMonth.toString().padStart(2, '0')}`);
//     }
...
function Ex_Month() {
  ...
  return (
    <div className="flex-col justify-center items-center min-h-screen bg-gray-100">
      <div className="max-w-md p-4 bg-white shadow-md rounded-md justify-center items-center">
        <h1 className="text-xl font-semibold mb-4">Select Year, Month, and Expense Type</h1>
        <div className="flex flex-row mb-4">
          ...
          <div>
            <label htmlFor="expenseTypeSelect" className="mb-2">Select Expense Type:</label>
            <select id="expenseTypeSelect" value={selectedExpenseType} onChange={handleExpenseTypeChange} className="border border-gray-300 rounded-md px-3 py-2 w-full focus:outline-none">
